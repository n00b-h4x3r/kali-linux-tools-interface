...
(1, 'Nmap', 'Nmap: the Network Mapper', 'information-gathering  vulnerability -analysis', 'https://blackarch.org/tools.html', 'https://insecure.org/', NULL, 'Yes', 'assets/img/nmap.jpg', 'nmap', NULL, 'Nmap (“Network Mapper”) is a free and open source (license) utility for network discovery and security auditing. Many systems and network administrators also find it useful for tasks such as network inventory, managing service upgrade schedules, and monitoring host or service uptime.', 'Information Gathering', 'Vulnerability Analysis', '<b>Nmap</b> works by checking a network for hosts and services. Once found, the software platform sends information to those hosts and services which then respond.\r\n\r\n<h2 style=\'color: white\'>FIX THIS</h2>\r\n<p></p>\r\n\r\n\r\n<h2 style=\'color: white\'>PROTECTION</h2>\r\n<p></p>'),
(2, 'BetterCap', 'bettercap', 'sniffing-spoofing', 'https://blackarch.org/tools.html', 'https://www.bettercap.org/', NULL, NULL, 'assets/img/bettercap.jpg', 'bettercap', NULL, NULL, 'Sniffing & Spoofing', NULL, NULL),
(3, 'theHarvester', 'theHarvester', 'information-gathering ', 'https://blackarch.org/tools.html', NULL, 'https://github.com/laramies/theHarvester', 'Yes', NULL, 'theharvester', '-d', 'The objective of this program is to gather emails, subdomains, hosts, employee names, open ports and banners from different public sources like search engines, PGP key servers and SHODAN computer database.', 'Information Gathering', NULL, '<b>theHarvester</b> is a great tool for collecting information from a particular host, with it it is possible to get a list of emails, subdomains, hosts, employee names, open ports, banners from different public sources, PGP keys and mapped information by SHODAN.\r\n\r\n<h2 style=\'color: white\'>FIX THIS</h2>\r\n<p>\r\nThe information found by theHarvester is indexed in Internet pages. If you want to hide this content you need to identify in the source of this information.\r\nFor this, one can be applied techniques like Google Hacking to refine the search in search engines users by theHarvester.\r\n\r\nOnce the data source is identified, you can hide or delete the data, for example, from a social network. If it is a content of your own, such as a personal blog, just create a robots.txt file and hide the pages that have the information.\r\n</p>\r\n\r\n\r\n<h2 style=\'color: white\'>USEFUL LINKS</h2>\r\n<strong>\r\n  <a href=\"https://securitytrails.com/blog/google-hacking-techniques\" class=\"text-warning\">• Google Hacking Techniques</a><br>\r\n  <a href=\"https://www.searchenginejournal.com/best-practices-setting-meta-robots-tags-robots-txt/188655/\" class=\"text-warning\">• Best Practices robots.txt</a>\r\n\r\n</strong>'),
(4, 'Nikto', 'Nikto', 'information-gathering  web-applications', 'https://blackarch.org/tools.html', 'https://www.cirt.net/Nikto2', 'https://github.com/sullo/nikto', NULL, 'assets/img/nikto.png', 'nikto', '-h', NULL, 'Information Gathering', 'Web Applications', NULL),
(5, 'Aircrack-ng', 'Airckack-ng', 'wireless- attacks', 'https://blackarch.org/tools.html', 'https://www.aircrack-ng.org/doku.php?id=aircrack-ng', 'https://gitlab.com/kalilinux/packages/aircrack-ng', NULL, NULL, NULL, NULL, NULL, 'Wireless Attacks', NULL, NULL),
(6, 'THC-Hydra', 'THC-Hydra', 'password-attacks', 'https://blackarch.org/tools.html', 'http://freeworld.thc.org/thc-hydra/', NULL, NULL, 'assets/img/hydrathc.jpg', NULL, NULL, NULL, 'Password Attacks', NULL, NULL),
(7, 'WPScan', 'WordPress Vulnerability Scanner', 'web-applications', 'https://blackarch.org/tools.html', 'http://wpscan.org/', 'https://github.com/wpscanteam/wpscan', NULL, 'assets/img/wpscan.png', 'wpscan', '--url', 'WPScan is a black box WordPress vulnerability scanner that can be used to scan remote WordPress installations to find security issues.', 'Web Applications', NULL, NULL),
(8, 'Dnstracer', 'dnstracer', 'information-gathering', 'https://blackarch.org/tools.html', 'http://freshmeat.net/projects/dnstracer', NULL, 'Yes', NULL, 'dnstracer', NULL, 'dnstracer determines where a given Domain Name Server (DNS) gets its information from for a given hostname, and follows the chain of DNS servers back to the authoritative answer.', 'Information Gathering', NULL, NULL),
(10, 'Sqlninja', 'Sqlninja', 'vulnerability-analysis  web-applications', 'https://blackarch.org/tools.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Vulnerability Analysis', 'Web Applications', NULL),
(11, 'Powerfuzzer', 'Powerfuzzer', 'vulnerability-analysis  web-applications', 'https://blackarch.org/tools.html', 'https://www.powerfuzzer.com/', NULL, NULL, NULL, NULL, NULL, NULL, 'Vulnerability Analysis', 'Web Applications', NULL),
(12, 'ProxyStrike', 'ProxyStrike', 'web-applications', 'https://blackarch.org/tools.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Web Applications', NULL, NULL),
(14, 'Dnsenum', 'Dnsenum', 'information-gathering', 'https://blackarch.org/tools.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Information Gathering', NULL, NULL),
